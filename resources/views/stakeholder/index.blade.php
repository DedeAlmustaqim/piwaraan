    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="card card-bordered card-preview">
            <div class="card-inner full-width">
                <a href="#" class="btn btn-info mb-2" data-bs-toggle="modal" data-bs-target="#modalStakeholder">+
                    Tambah Stakeholder</a>
                <hr>

                <div class="table-responsive">
                    <table width="100%" class="table wrap table-bordered table-striped" id="TblStakholder">
    ...
    <script>
        ...
        function showStakholder() {
            ...
            $('#TblStakholder').DataTable({
                ...
                "displayLength": 25,
                "ajax": {
                    "url": BASE_URL + "/stakeholder/get-stakeholder",
                },
                "columns": [{
                        "orderable": false,
                        "data": function(data) {
