        ...
        <div class="card card-bordered card-preview">
            <div class="card-inner full-width">
                ...
                <div class="table-responsive">
                    <table width="100%" class="table wrap table-bordered table-striped" id="TblPotensiPajakReject">
    ...
    <script>
        ...
        function showPotensiPajakReject() {
            ...
            $('#TblPotensiPajakReject').DataTable({
                ...
                "displayLength": 25,
                "ajax": {
                    "url": BASE_URL + "/pendataan/get_reject",
                },
                "columns": [{
                        "orderable": false,
                        "data": function(data) {
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "data": function(data, ) {
                            return '<div class="text-center"><span class="badge bg-danger">Dibatalkan</span></div>'
                        }
                    },
                    {
